<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>lecturers/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL LECTURERS</button></a> 
                <a href="<?= BASE_URL ?>lecturers/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('lecturers/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a lecturer record.  This cannot be undone. <br>
...
<?= Modules::run('associated_students_and_lecturers/_draw_association_info', $token) ?>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/lecturers';
    var params = {
...
window.onload = function() {
    ...
    populateAssociationInfo('associated_students_and_lecturers');
