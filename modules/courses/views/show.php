<div class="w3-row">
    <div class="w3-container">   
        ...
        <div class="w3-card-4">
            ...
            <div class="w3-container">
            <p>
                <a href="<?= BASE_URL ?>courses/manage"><button class="w3-button w3-white w3-border"><i class="fa fa-list-alt"></i> VIEW ALL COURSES</button></a> 
                <a href="<?= BASE_URL ?>courses/create/<?= $update_id ?>"><button class="w3-button w3-white w3-border"><i class="fa fa-pencil"></i> UPDATE DETAILS</button></a>
                ...
                <div id="delete-record-modal" class="w3-modal w3-center" style="padding-top: 7em;">
                    <div class="w3-modal-content w3-animate-right w3-card-4" style="width: 30%;">
                        ...
                        <div class="w3-container">
                            <?php 
                            echo form_open('courses/submit_delete/'.$update_id);
                            ?>
                            <h5>Are you sure?</h5>
                            <p>You are about to delete a course record.  This cannot be undone. <br>
...
<div class="w3-third w3-container">    
        <div class="w3-card-4 edit-block" style="margin-top: 1em;">
            ...
            <div class="edit-block-content">
              <div class="w3-border-bottom"><b>Course Title:</b> <span class="w3-right w3-text-grey"><?= $course_title ?></span></div>
              <div class="w3-border-bottom"><b>Course Description:</b> <span class="w3-text-grey"><br><?= nl2br($course_description) ?></span></div>
              <div class="w3-border-bottom"><b>Start Date:</b> <span class="w3-right w3-text-grey"><?= $start_date ?></span></div>
              <div class="w3-border-bottom"><b>Finish Date:</b> <span class="w3-right w3-text-grey"><?= $finish_date ?></span></div>
              <div class="w3-border-bottom"><b>Started Time:</b> <span class="w3-right w3-text-grey"><?= $started_time ?></span></div>
              <div class="w3-border-bottom"><b>Finished Time:</b> <span class="w3-right w3-text-grey"><?= $finished_time ?></span></div>              
            </div>
        </div>
    </div>
    
<?= Modules::run('associated_courses_and_lecturers/_draw_association_info', $token) ?>


<?= Modules::run('associated_courses_and_students/_draw_association_info', $token) ?>
...
function populateAssociationInfo(relationshipModule) {
    ...
    var apiUrl = '<?= BASE_URL ?>' + relationshipModule + '/fetch/<?= $update_id ?>/courses';
    var params = {
...
window.onload = function() {
    ...
    populateAssociationInfo('associated_courses_and_lecturers');
    populateAssociationInfo('associated_courses_and_students');
