<div class="w3-row">
    <div class="w3-container">
        ...
        <p>
            ...
            <a href="<?= BASE_URL ?>courses/resume"><button class="w3-button w3-medium primary">
                <i class="fa fa-pencil"></i> VIEW RESUME</button>
            </a>
        </p>
...
function getRecords() {
  ...
  var target_url = '<?= BASE_URL ?>api/get/courses';
